        ...
        <div className="bg-card rounded-2xl p-6 lg:p-8 shadow-lg border-2 border-primary/30 mb-12 overflow-hidden">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div className="space-y-4">
              <a href="https://pay.caminhodasaude.com/nWrxGWAr01X3654" target="_blank" rel="noopener noreferrer" className="inline-block bg-destructive/10 text-destructive px-3 py-1 rounded-full text-xs font-bold hover:bg-destructive/20 transition-colors">MAIS VENDIDO 🏆</a>
            ...
            <div className="relative">
              <img
                ...
                decoding="async"
              />
              <a href="https://pay.caminhodasaude.com/nWrxGWAr01X3654" target="_blank" rel="noopener noreferrer" className="absolute -top-3 -right-3 bg-destructive text-destructive-foreground px-3 py-1 rounded-full text-xs font-bold animate-pulse hover:bg-destructive/90 transition-colors">
                #1 BRASIL
              </a>
            </div>
          </div>
